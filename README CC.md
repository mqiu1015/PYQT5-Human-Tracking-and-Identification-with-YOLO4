...
```python
git clone https://github.com/CC/Person-Live-Tracking-and-Identification
```
- Create a project environment
```python
cd Person-Live-Tracking-and-Identification
conda create --name APP python=3.6.5
conda activate APP
```
...
```
# # Convert models
- Download the YOLO models for [YOLO_v4](https://drive.google.com/file/d/1w9furPagm3KytRW2uNooLcBoiYWDwbop/view?usp=sharing) and add them to /model_data/weights/
* YOLO_v4
```python
...
- Download the Keras models for [YOLO_v4](https://drive.google.com/file/d/1pwFo4aHKPi0ztpL5tEYaXIr8RltYYQeY/view?usp=sharing) and add them to \model_data\models\
